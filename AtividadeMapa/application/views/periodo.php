...
=======
                    <li class="nav-item"><a class="nav-link" href="../funcoes/abreperiodo">Turma</a></li>
    ...
    <script>
        async function cadastro() {
            ...
            try {
                ...
                if (result.codigo == 1) {
                    ...
                    const mensagensDeErro = result.errors.map(erro => {
        ...
        async function editarPeriodo() {
            ...
            try {
                ...
                console.error('Erro ao cadastrar a Período:', error);
                Swal.fire('Erro', 'Ocorreu um erro ao processar a requisição.', 'error');
            }
        }
