...
class _LoginScreenState extends State<LoginScreen> {
  ...
  try {
    // 1. Chamada à API
    final usuario = await ApiService.instance.login(
      email: email, 
      senha: senha,
    );
    ...
    // 2. Redirecionamento dinâmico por perfil de usuário
    ...
    // Tratamento de erros conhecidos retornados pelo servidor
    ...
    // Tratamento de falhas de conexão ou timeouts
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
